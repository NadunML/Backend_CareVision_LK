...
def generate_frames(cam_id):
    ...
    while True:
        ...
        if frame_counter % 4 == 0:
            ...
            # --- 1. CAMERA 01 (Patient Identification) ---
            if cam_id == '1' and modes['patientIdent']:
                try:
            ...
            # --- 2. CAMERA 02 (Strict Deep Learning Mask Detection) ---
            elif cam_id == '2' and modes['maskDetect']:
                try:
                    ...
                    for (x, y, w, h) in faces:
                        ...
                        # මූණ ගොඩක් දුරින්/පොඩියට තියෙනවා නම් අතාරිනවා (බොරු සිග්නල් නවත්තන්න)
                        if w < 20 or h < 20:
                            continue
                        ...
                        if maskNet is not None:
                            ...
                            if face_img.size > 0:
                                ...
                                # 🔥 තද නීතිය: Without Mask ප්‍රතිශතය Mask එකට වඩා වැඩි නම් විතරක් NO MASK
            ...
            # --- 3. CAMERA 03 (YOLOv8 STRICT FIRE Detection Only) ---
            elif cam_id == '3' and modes['fireDetect']:
                try:
                    temp_fire_status = []
                    if fire_model is not None:
                        ...
                        for r in results:
                            ...
                            for box in boxes:
                                ...
                                # 🔥 වෙනස්කම: 'FIRE' කියන වචනේ තියෙනවා නම් සහ 50% ට වඩා ෂුවර් නම් විතරක් අල්ලනවා.
                                # Smoke ඔක්කොම අතෑරලා දානවා!
                                if 'FIRE' in class_name and conf > 0.50:
        ...
        if cam_id == '1' and modes['patientIdent']:
            ...
            if len(last_fire_status) > 0:
                ...
                for (x1, y1, x2, y2, conf, class_name) in last_fire_status:
                    # දැන් වැටෙන්නේ FIRE කියලා විතරමයි
